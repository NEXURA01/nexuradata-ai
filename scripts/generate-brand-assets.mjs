...
function wordmark(x, y, size = 72, spacing = 3.6, anchor = 'start') {
  return `<text x="${x}" y="${y}" font-family="${FONT}" font-size="${size}" font-weight="800" letter-spacing="${spacing}" fill="${OS}" text-anchor="${anchor}">NEXURA Analytics</text>`;
}
...
console.log('Generating NEXURA Analytics brand assets...\n');
