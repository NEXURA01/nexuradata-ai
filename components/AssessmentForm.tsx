        ...
        <AnimatePresence mode="wait">
          {!estimate ? (
            ...
            >
              {/* Company */}
              <div>
                <label className="ref-number block mb-2">{t("form.company")}</label>
                <input
                  type="text"
                  required
              ...
              {/* Name */}
              <div>
                <label className="ref-number block mb-2">{t("form.name")}</label>
                <input
                  type="text"
                  required
                  value={formData.name}
              ...
              {/* Email */}
              <div>
                <label className="ref-number block mb-2">{t("form.email")}</label>
                <input
                  type="email"
                  required
              ...
              {/* Problem */}
              <div>
                <label className="ref-number block mb-2">{t("form.problem")}</label>
                <textarea
                  required
                  rows={4}
              ...
              {/* Tools */}
              <div>
                <label className="ref-number block mb-2">{t("form.tools")}</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="ref-number block mb-2">{t("form.teams")}</label>
                  <input
                    type="number"
                    min="1"
                ...
                <div>
                  <label className="ref-number block mb-2">{t("form.urgency")}</label>
                  <select
